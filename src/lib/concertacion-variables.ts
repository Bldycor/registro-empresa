// Valoración del Momento 1 (Concertación/Planeación): 6 variables sobre la calidad de la
...
export const VARIABLES_PLANEACION = [
  ...
  "ACTIVIDADES_PLANTEADAS",
  "EVIDENCIAS_PLANTEADAS",
  "AFILIACION_ARL",
  "HORARIO_ACORDADO",
...
export const variablePlaneacionLabel: Record<VariablePlaneacionEP, string> = {
  ...
  ACTIVIDADES_PLANTEADAS: "Actividades bien planteadas",
  EVIDENCIAS_PLANTEADAS: "Evidencias de aprendizaje bien planteadas",
